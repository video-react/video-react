...
export default class PlayerPage extends Component {
  ...
  static async getInitialProps ({ query }) {
    const responsePlayer = await fetch(`http://localhost:9000/code/Player.js`)
    const responsePlayerControl = await fetch(`http://localhost:9000/code/PlayerControl.js`)
    const PlayerExampleSource = await responsePlayer.text()
    const PlayerControlExampleSource = await responsePlayerControl.text()
    return { PlayerExampleSource, PlayerControlExampleSource }
  }
  ...
  render() {
    ...
    return (
      <Layout page="Player">
        <Head>
          <title>Video-React - Player</title>
        </Head>
        <h3>Player</h3>
        <p>
        ...
        <h4>Attributes</h4>
        <p>
          All the attributes for the <code>Player</code> component, they can be added as React properties.
        </p>
        <Table bordered>
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                you may instead use the <code>&lt;source&gt;</code> element within the <code>Player</code> block to specify the video to embed.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                Posible values: <code>auto</code>, <code>16:9</code>, <code>4:3</code>, etc.
              </td>
            </tr>
            <tr>
...
this.refs.player.playbackRate = 2; `
            ...
            <tr>
              ...
              <td>Returns the <code>Video</code> component object</td>
            </tr>
          </tbody>
        </Table>
        <h4>Methods</h4>
        <p>
          The <code>Player</code> component has some methods to control the video and the player.
        </p>
        <Table bordered>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td><a name="getState"></a><code>getState()</code></td>
              <td>
...
console.log(player.currentTime); // print current time`
            ...
            <tr>
              <td><code>forward(seconds)</code></td>
              <td>
                Jump forward x seconds
              </td>
            </tr>
            <tr>
              <td><code>replay(seconds)</code></td>
              <td>
                Jump back x seconds
              </td>
            </tr>
            ...
            <tr>
              <td><code>subscribeToStateChange(listener)</code></td>
              <td>
...
handleStateChange(state, prevState) {
  ...
  this.setState({
    ...
    currentTime: state.currentTime
        ...
        <p>
          We use <code>redux</code> to manage the player state.
          Using <a href="#getState">getState</a> method can get the state object.
          This is the list of all the states.
        </p>
        <Table bordered>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td colSpan="2">
                The <code>player</code> state includes all the states about the video and the player.
                Below is the properties list of the <code>player</code> state.
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td>Returns the current playback position in the video (in seconds)</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><code>seekingTime</code></td>
              <td>Returns the current seeking position in the video (in seconds)</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><code>buffered</code></td>
              <td>Returns a TimeRanges object representing the buffered parts of the video</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><code>autoPaused</code></td>
              <td>Returns whether the player has been paused by the player itself</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
        ...
        <p>This is an example on how to control the player from outside the component.</p>
